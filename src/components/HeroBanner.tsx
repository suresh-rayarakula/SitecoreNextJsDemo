import { Text, Field, withDatasourceCheck, RichText as JssRichText, Image as JssImage , ImageField} from '@sitecore-jss/sitecore-jss-nextjs';
...
const HeroBanner = (props: HeroBannerProps): JSX.Element => (
  <div>
    ...
    <p><JssRichText field={props.fields.description} /></p>
